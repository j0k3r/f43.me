...
use Api43\FeedBundle\Readability\Readability;
use Api43\FeedBundle\Readability\JSLikeHTMLElement;
...
class ReadabilityTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testInitNoContent()
    {
        ...
        $this->assertInstanceOf('Api43\FeedBundle\Readability\JSLikeHTMLElement', $readability->getContent());
