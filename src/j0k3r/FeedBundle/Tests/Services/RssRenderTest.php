...
use j0k3r\FeedBundle\Services\RssRender;
...
class RssRenderTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->dm->expects($this->any())
            ...
            ->with($this->equalTo('j0k3rFeedBundle:FeedItem'))
            ->willReturn($repo);
    ...
    {
        $feed = $this->getMock('j0k3r\FeedBundle\Document\Feed');
    ...
    {
        $feed = $this->getMockBuilder('j0k3r\FeedBundle\Document\Feed')
